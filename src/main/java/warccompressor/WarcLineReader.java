...
public class WarcLineReader {
     ...
     * @throws IOException
     */
    public WarcLineReader(InputStream in) {
     ...
     * @throws IOException
     */
    public WarcLineReader(InputStream in, int bufferSize) {
        this.in = in;
     ...
     * @throws IOException
     */
    public WarcLineReader(InputStream in, Configuration conf) throws IOException {
     ...
     */
    public WarcLineReader(InputStream in, byte[] recordDelimiterBytes) {
        this.in = in;
     ...
     * @throws IOException
     */
    public WarcLineReader(InputStream in, Configuration conf,
    ...
    public int readLine(Text str, int maxLineLength,
        ...
        if (this.recordDelimiterBytes != null) {
            return readWarcLine(str, maxLineLength, maxBytesToConsume);
        } else {
     ...
     */
    private int readWarcLine(Text str, int maxLineLength, int maxBytesToConsume)
            throws IOException {
        str.clear();
        int txtLength = 0; // tracks str.getLength(), as an optimization
        long bytesConsumed = 0;
